...
5. **Pinning for consumers** — downstream workflows should use a **release tag** (for example **`codestep-io/codestep-lens@v0.1.3`**), not **`@main`**, unless they intentionally track head.
