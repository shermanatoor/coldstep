...
5. **Pinning for consumers** — downstream workflows should use a **release tag** (for example **`coldstep-io/coldstep@v0.1.3`**), not **`@main`**, unless they intentionally track head.
